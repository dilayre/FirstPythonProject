...
def iron():
    ...
    part1=[[(-40, 120), (-70, 260), (-130, 230), (-170, 200),
    ...
    part2=[[(-40, -30), (-50, -40), (-100, -46), (-130, -40), (-176, 0),
    ...
    part3=[[(-60, -220), (-80, -240), (-110, -220), (-120, -250),(-90, -280),
    ...
    draw_piece(part1,p1goto)
    draw_piece(part2,p2goto)
    draw_piece(part3,p3goto)
